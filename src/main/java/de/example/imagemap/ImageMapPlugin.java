...
public class ImageMapPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        int purged = jobStore.purgeStaleAnchors();
        if (purged > 0) {
            getLogger().info(purged + " veraltete Auto-Place-Anker-Einträge aus früheren/fehlgeschlagenen "
                    + "Versuchen entfernt.");
        }
        ...
        Bukkit.getPluginManager().registerEvents(new AutoPlaceListener(this), this);
    }
